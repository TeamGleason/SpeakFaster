...
Additionally, a JSON file named `curated_processed.json` is generated by the
postprocessing script to accompany the TSV file. This file contains metadata such
as timestamps and statistics of the curated speech utterances (e.g., automatically
extracted part-of-speech tags, token count and lenghts, etc. prior to redaction).
